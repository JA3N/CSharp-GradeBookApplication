...
namespace GradeBook.UserInterfaces
{
    public static class StartingUserInterface
    {
        ...
        public static void CreateCommand(string command)
        {
            ...
            if (parts[3].Equals(GradeBookType.Standard)) gradeBook = new StandardGradeBook(name);
            else if (parts[3].Equals(GradeBookType.Ranked)) gradeBook = new RankedGradeBook(name);
